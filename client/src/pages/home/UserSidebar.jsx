...
const UserSidebar = () => {
  ...
  return (
    <div className="max-w-[20em] w-full h-screen  flex flex-col border-r border-r-white/15 ">
      <h1 className="bg-black mx-3 px-2 py-1 text-[#7480FF] text-xl font-semibold rounded-lg mt-3 ">
        WeChat
      </h1>
      <div className="p-3">
      ...
      <div className="flex items-center justify-between p-3">
        ...
        <button onClick={handelLogout} className="btn btn-primary btn-sm px-4">
          Logout
        </button>
      </div>
    </div>
